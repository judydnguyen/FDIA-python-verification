...
MODEL_PATH="../fdia_model_ffnn_pytorch_50_100_50.onnx"
python3 ../examples/fdia/generate_massive_spec.py -e 0.01 -n 10 -m $MODEL_PATH
python3 ../examples/fdia/generate_massive_spec.py -e 0.025 -n 10 -m $MODEL_PATH
python3 ../examples/fdia/generate_massive_spec.py -e 0.005 -n 10 -m $MODEL_PATH
